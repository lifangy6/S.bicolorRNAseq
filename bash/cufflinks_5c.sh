...
#SBATCH --job-name cufflinks_5c_job
#SBATCH --nodes=8
#SBATCH --ntasks-per-node=40
#SBATCH --time=12:00:00
#SBATCH --output=/scratch/n/nprovart/lifangy6/outputs/cufflinks_5c_output_%j.out
...
OUTPUT_DIR="cufflinks_5c_output"
ANNOTATION_FILE="Sbicolor_annotations.gtf"

# Define sample labels for each group
LABELS="seed_wt,seed_plasma,seed_dry,shoot_wt,shoot_plasma"
...
GROUP3_BAMS="bam_files/seed_dry_1.bam,bam_files/seed_dry_2.bam,bam_files/seed_dry_3.bam"
GROUP4_BAMS="bam_files/shoot_wt_1.bam,bam_files/shoot_wt_2.bam,bam_files/shoot_wt_3.bam"
GROUP5_BAMS="bam_files/shoot_plasma_1.bam,bam_files/shoot_plasma_2.bam,bam_files/shoot_plasma_3.bam"
